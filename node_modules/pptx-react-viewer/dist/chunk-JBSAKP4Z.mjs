...
var animationPresetTranslationsEn = {
...
var translationsEn = {
  ...
  "pptx.autosave.recovery.message": 'An autosaved copy of "{{file}}" ({{size}}) has changes that are not in the version you just opened.',
  ...
  "pptx.animation.nativeEffectHint": "Added in PowerPoint. Drag your own effects ahead of or behind it.",
  ...
  "pptx.fonts.embedUnavailable": "This presentation carries no embedded font data, and font files cannot be read from your system, so there is nothing to embed.",
  ...
  "pptx.slideTemplates.sectionHeader.description": "Accent side panel with section number and title",
  ...
  "pptx.slideTemplates.content.quoteText": "A memorable quote that captures the message of this presentation.",
  ...
  "pptx.options.general.fontsDescription": "Presentations sometimes use fonts your device does not have installed, and the viewer substitutes the closest available face. Adding the font file makes the deck render with the font it was written in.",
  "pptx.options.general.enableCustomFonts": "Let me add font files to this session",
  "pptx.options.general.enableCustomFontsInfo": "Added fonts are used for rendering and appear in the Home tab font list. They are held in memory only, are never uploaded or saved into the presentation, and are discarded when you reload the page.",
  ...
  "pptx.textAdvanced.direction.vertical": "Rotate all text 90\xB0",
  "pptx.textAdvanced.direction.vertical270": "Rotate all text 270\xB0",
  ...
  "pptx.backstage.optionsBody": "Configure autosave, proofing, grid, rulers, language, theme, and keyboard shortcuts.",
  ...
  "pptx.backstage.card.inspect.body": "Review document properties, accessibility, and hidden content.",
  "pptx.backstage.card.embedFonts.title": "Embed Fonts",
  "pptx.backstage.card.embedFonts.body": "Keep typography consistent when the file moves between devices.",
  "pptx.backstage.card.signatures.title": "Digital Signatures",
  "pptx.backstage.card.signatures.body": "View and manage signatures attached to this presentation.",
  ...
  "pptx.backstage.card.json.body": "Save a portable JSON document that re-imports with full fidelity.",
  ...
  "pptx.readOnly.unsupportedAlgorithm": "This file's password protection cannot be verified by this viewer.",
  ...
  "pptx.slideSize.rescaleDescription": "You are changing the slide size. Choose how to fit the existing content.",

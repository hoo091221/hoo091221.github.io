...
var require_simplepeer_min = chunk4VNS5WPM_js.__commonJS({
  "../../node_modules/.bun/simple-peer@9.11.1/node_modules/simple-peer/simplepeer.min.js"(exports, module) {
    (function(e) {
      ...
      return (/* @__PURE__ */ (function() {
        function d(s, e, n2) {
          function t2(o, i) {
            if (!e[o]) {
              if (!s[o]) {
                var l = "function" == typeof chunk4VNS5WPM_js.__require && chunk4VNS5WPM_js.__require;
          ...
          for (var r2 = "function" == typeof chunk4VNS5WPM_js.__require && chunk4VNS5WPM_js.__require, a = 0; a < n2.length; a++) t2(n2[a]);
          return t2;
        }
        return d;
      })())({ 1: [function(e, t2, n2) {
...
var setupWS = (wsclient) => {
  if (wsclient.shouldConnect && wsclient.ws === null) {
    ...
    websocket.onmessage = (event) => {
      wsclient.lastMessageReceived = chunkZYQT7I5C_js.getUnixTime();
    ...
    const onclose = (error) => {
      if (wsclient.ws !== null) {
        ...
        setTimeout(setupWS, chunkZYQT7I5C_js.min(chunkZYQT7I5C_js.log10(wsclient.unsuccessfulReconnects + 1) * reconnectTimeoutBase, maxReconnectTimeout), wsclient);
      }
      clearTimeout(pingTimeout);
    };
    const sendPing = () => {
...
var WebsocketClient = class extends chunkZYQT7I5C_js.Observable {
  /**
   * @param {string} url
   * @param {object} opts
  ...
  constructor(url, { binaryType } = {}) {
    ...
    this._checkInterval = setInterval(() => {
      if (this.connected && messageReconnectTimeout < chunkZYQT7I5C_js.getUnixTime() - this.lastMessageReceived) {
        this.ws.close();
      }
...
// ../../node_modules/.bun/y-webrtc@10.3.0+48ebd0cf55a3d4ab/node_modules/y-webrtc/src/y-webrtc.js
var import_simplepeer_min = chunk4VNS5WPM_js.__toESM(require_simplepeer_min(), 1);

// ../../node_modules/.bun/y-webrtc@10.3.0+48ebd0cf55a3d4ab/node_modules/y-webrtc/src/crypto.js
var deriveKey = (secret, roomName) => {
  const secretBuffer = chunkZYQT7I5C_js.encodeUtf8(secret).buffer;
  const salt = chunkZYQT7I5C_js.encodeUtf8(roomName).buffer;
...
var encrypt = (data, key) => {
  ...
  return crypto.subtle.encrypt(
    ...
    const encryptedDataEncoder = chunkZYQT7I5C_js.createEncoder();
    chunkZYQT7I5C_js.writeVarString(encryptedDataEncoder, "AES-GCM");
    chunkZYQT7I5C_js.writeVarUint8Array(encryptedDataEncoder, iv);
    chunkZYQT7I5C_js.writeVarUint8Array(encryptedDataEncoder, new Uint8Array(cipher));
    return chunkZYQT7I5C_js.toUint8Array(encryptedDataEncoder);
  });
};
var encryptJson = (data, key) => {
  const dataEncoder = chunkZYQT7I5C_js.createEncoder();
  chunkZYQT7I5C_js.writeAny(dataEncoder, data);
  return encrypt(chunkZYQT7I5C_js.toUint8Array(dataEncoder), key);
};
var decrypt = (data, key) => {
  ...
  const dataDecoder = chunkZYQT7I5C_js.createDecoder(data);
  const algorithm = chunkZYQT7I5C_js.readVarString(dataDecoder);
  if (algorithm !== "AES-GCM") {
    chunkZYQT7I5C_js.reject(chunkZYQT7I5C_js.create2("Unknown encryption algorithm"));
  }
  const iv = chunkZYQT7I5C_js.readVarUint8Array(dataDecoder);
  const cipher = chunkZYQT7I5C_js.readVarUint8Array(dataDecoder);
...
var decryptJson = (data, key) => decrypt(data, key).then(
  (decryptedValue) => chunkZYQT7I5C_js.readAny(chunkZYQT7I5C_js.createDecoder(new Uint8Array(decryptedValue)))
);

// ../../node_modules/.bun/y-webrtc@10.3.0+48ebd0cf55a3d4ab/node_modules/y-webrtc/src/y-webrtc.js
var log = chunkZYQT7I5C_js.createModuleLogger("y-webrtc");
var messageSync = 0;
...
var checkIsSynced = (room) => {
  ...
  if (!synced && room.synced || synced && !room.synced) {
    ...
    log("synced ", chunkZYQT7I5C_js.BOLD, room.name, chunkZYQT7I5C_js.UNBOLD, " with all peers");
  }
};
var readMessage = (room, buf, syncedCallback) => {
  ...
  switch (messageType) {
    case messageSync: {
      ...
      const syncMessageType = chunkNB7M4XBG_js.readSyncMessage(decoder, encoder, doc, room);
      if (syncMessageType === chunkNB7M4XBG_js.messageYjsSyncStep2 && !room.synced) {
        syncedCallback();
      }
      if (syncMessageType === chunkNB7M4XBG_js.messageYjsSyncStep1) {
        sendReply = true;
      }
      break;
    }
    case messageQueryAwareness:
      ...
      chunkZYQT7I5C_js.writeVarUint8Array(encoder, chunkNB7M4XBG_js.encodeAwarenessUpdate(awareness, Array.from(awareness.getStates().keys())));
      sendReply = true;
      break;
    case messageAwareness:
      chunkNB7M4XBG_js.applyAwarenessUpdate(awareness, chunkZYQT7I5C_js.readVarUint8Array(decoder), room);
      break;
    case messageBcPeerId: {
      const add = chunkZYQT7I5C_js.readUint8(decoder) === 1;
      const peerName = chunkZYQT7I5C_js.readVarString(decoder);
...
var readPeerMessage = (peerConn, buf) => {
  ...
  log("received message from ", chunkZYQT7I5C_js.BOLD, peerConn.remotePeerId, chunkZYQT7I5C_js.GREY, " (", room.name, ")", chunkZYQT7I5C_js.UNBOLD, chunkZYQT7I5C_js.UNCOLOR);
  return readMessage(room, buf, () => {
    peerConn.synced = true;
    log("synced ", chunkZYQT7I5C_js.BOLD, room.name, chunkZYQT7I5C_js.UNBOLD, " with ", chunkZYQT7I5C_js.BOLD, peerConn.remotePeerId);
    checkIsSynced(room);
  });
};
var sendWebrtcConn = (webrtcConn, encoder) => {
  log("send message to ", chunkZYQT7I5C_js.BOLD, webrtcConn.remotePeerId, chunkZYQT7I5C_js.UNBOLD, chunkZYQT7I5C_js.GREY, " (", webrtcConn.room.name, ")", chunkZYQT7I5C_js.UNCOLOR);
  try {
    webrtcConn.peer.send(chunkZYQT7I5C_js.toUint8Array(encoder));
  } catch (e) {
  }
};
var broadcastWebrtcConn = (room, m) => {
  log("broadcast message in ", chunkZYQT7I5C_js.BOLD, room.name, chunkZYQT7I5C_js.UNBOLD);
...
var WebrtcConn = class {
  ...
  constructor(signalingConn, initiator, remotePeerId, room) {
    log("establishing connection to ", chunkZYQT7I5C_js.BOLD, remotePeerId);
    this.room = room;
    ...
    this.peer.on("connect", () => {
      log("connected to ", chunkZYQT7I5C_js.BOLD, remotePeerId);
      this.connected = true;
      ...
      if (awarenessStates.size > 0) {
        const encoder2 = chunkZYQT7I5C_js.createEncoder();
        chunkZYQT7I5C_js.writeVarUint(encoder2, messageAwareness);
        chunkZYQT7I5C_js.writeVarUint8Array(encoder2, chunkNB7M4XBG_js.encodeAwarenessUpdate(awareness, Array.from(awarenessStates.keys())));
    ...
    this.peer.on("close", () => {
      ...
      checkIsSynced(room);
      this.peer.destroy();
      log("closed connection to ", chunkZYQT7I5C_js.BOLD, remotePeerId);
      announceSignalingInfo(room);
    });
    this.peer.on("error", (err) => {
      log("Error in connection to ", chunkZYQT7I5C_js.BOLD, remotePeerId, ": ", err);
      announceSignalingInfo(room);
    });
...
var broadcastBcMessage = (room, m) => encrypt(m, room.key).then(
  (data) => room.mux(
    () => chunkNB7M4XBG_js.publish(room.name, data)
  )
);
...
var broadcastBcPeerId = (room) => {
  if (room.provider.filterBcConns) {
    const encoderPeerIdBc = chunkZYQT7I5C_js.createEncoder();
    chunkZYQT7I5C_js.writeVarUint(encoderPeerIdBc, messageBcPeerId);
    chunkZYQT7I5C_js.writeUint8(encoderPeerIdBc, 1);
    chunkZYQT7I5C_js.writeVarString(encoderPeerIdBc, room.peerId);
    broadcastBcMessage(room, chunkZYQT7I5C_js.toUint8Array(encoderPeerIdBc));
  }
};
var Room = class {
  /**
  ...
  constructor(doc, provider, name, key) {
    this.peerId = chunkZYQT7I5C_js.uuidv4();
    this.doc = doc;
    ...
    this._bcSubscriber = (data) => decrypt(new Uint8Array(data), key).then(
      (m) => this.mux(() => {
        ...
        if (reply) {
          broadcastBcMessage(this, chunkZYQT7I5C_js.toUint8Array(reply));
        }
      })
    );
    this._docUpdateHandler = (update, _origin) => {
      ...
      broadcastRoomMessage(this, chunkZYQT7I5C_js.toUint8Array(encoder));
    };
    this._awarenessUpdateHandler = ({ added, updated, removed }, _origin) => {
      const changedClients = added.concat(updated).concat(removed);
      const encoderAwareness = chunkZYQT7I5C_js.createEncoder();
      chunkZYQT7I5C_js.writeVarUint(encoderAwareness, messageAwareness);
      chunkZYQT7I5C_js.writeVarUint8Array(encoderAwareness, chunkNB7M4XBG_js.encodeAwarenessUpdate(this.awareness, changedClients));
      broadcastRoomMessage(this, chunkZYQT7I5C_js.toUint8Array(encoderAwareness));
    };
    this._beforeUnloadHandler = () => {
      chunkNB7M4XBG_js.removeAwarenessStates(this.awareness, [doc.clientID], "window unload");
      rooms.forEach((room) => {
        room.disconnect();
      });
    };
  ...
  connect() {
    ...
    chunkNB7M4XBG_js.subscribe(roomName, this._bcSubscriber);
    ...
    broadcastBcMessage(this, chunkZYQT7I5C_js.toUint8Array(encoderSync));
    ...
    broadcastBcMessage(this, chunkZYQT7I5C_js.toUint8Array(encoderState));
    ...
    broadcastBcMessage(this, chunkZYQT7I5C_js.toUint8Array(encoderAwarenessQuery));
    ...
    chunkZYQT7I5C_js.writeVarUint8Array(encoderAwarenessState, chunkNB7M4XBG_js.encodeAwarenessUpdate(this.awareness, [this.doc.clientID]));
    broadcastBcMessage(this, chunkZYQT7I5C_js.toUint8Array(encoderAwarenessState));
  }
  disconnect() {
    signalingConns.forEach((conn) => {
      if (conn.connected) {
    ...
    chunkNB7M4XBG_js.removeAwarenessStates(this.awareness, [this.doc.clientID], "disconnect");
    const encoderPeerIdBc = chunkZYQT7I5C_js.createEncoder();
    chunkZYQT7I5C_js.writeVarUint(encoderPeerIdBc, messageBcPeerId);
    chunkZYQT7I5C_js.writeUint8(encoderPeerIdBc, 0);
    chunkZYQT7I5C_js.writeVarString(encoderPeerIdBc, this.peerId);
    broadcastBcMessage(this, chunkZYQT7I5C_js.toUint8Array(encoderPeerIdBc));
    chunkNB7M4XBG_js.unsubscribe(this.name, this._bcSubscriber);
    this.bcconnected = false;
...
var openRoom = (doc, provider, name, key) => {
  if (rooms.has(name)) {
    throw chunkZYQT7I5C_js.create2(`A Yjs Doc connected to room "${name}" already exists!`);
  }
...
var publishSignalingMessage = (conn, room, data) => {
  if (room.key) {
    encryptJson(data, room.key).then((data2) => {
      conn.send({ type: "publish", topic: room.name, data: chunkZYQT7I5C_js.toBase64(data2) });
    });
  } else {
        ...
        case "publish": {
            ...
            switch (data.type) {
              case "announce":
                if (webrtcConns.size < room.provider.maxConns) {
                  chunkZYQT7I5C_js.setIfUndefined(webrtcConns, data.from, () => new WebrtcConn(this, true, data.from, room));
                  emitPeerChange();
                }
                break;
              case "signal":
                ...
                if (data.to === peerId) {
                  chunkZYQT7I5C_js.setIfUndefined(webrtcConns, data.from, () => new WebrtcConn(this, false, data.from, room)).peer.signal(data.signal);
                  emitPeerChange();
                }
                break;
            }
          ...
          if (room.key) {
            if (typeof m.data === "string") {
              decryptJson(chunkZYQT7I5C_js.fromBase64(m.data), room.key).then(execMessage);
            }
          } else {
            execMessage(m.data);
          }
...
var WebrtcProvider = class extends chunkZYQT7I5C_js.ObservableV2 {
  /**
  ...
  constructor(roomName, doc, {
    ...
    maxConns = 20 + chunkZYQT7I5C_js.floor(chunkZYQT7I5C_js.rand() * 15),
  ...
  connect() {
    ...
    this.signalingUrls.forEach((url) => {
      const signalingConn = chunkZYQT7I5C_js.setIfUndefined(signalingConns, url, () => new SignalingConn(url));

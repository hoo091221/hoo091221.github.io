...
import { Doc } from 'yjs';
import React$1, { RefObject, Dispatch, SetStateAction, ForwardedRef } from 'react';
...
//#endregion
//#region src/core/types/geometry.d.ts
/**
...
//#endregion
//#region src/core/types/shape-style.d.ts
...
//#endregion
//#region src/core/types/element-base.d.ts
/**
...
//#endregion
//#region src/core/types/chart-pivot-source.d.ts
...
//#endregion
//#region src/core/types/chart-print-settings.d.ts
...
//#endregion
//#region src/core/types/chart-protection.d.ts
...
//#endregion
//#region src/core/types/smart-art-layout-definition.d.ts
...
//#endregion
//#region src/core/types/smart-art-node.d.ts
/**
...
//#endregion
//#region src/core/types/smart-art.d.ts
/**
...
//#endregion
//#region src/core/types/transition.d.ts
/**
...
type MergeShapeOperation = 'union' | 'intersect' | 'subtract' | 'fragment' | 'combine';
...
//#endregion
//#region src/render/motion-path-authoring.d.ts
/**
 ...
 */
type AnimationApplyGroup = 'entrance' | 'emphasis' | 'exit' | 'motionPath';
//#endregion
//#region src/render/slide-templates/slide-template-types.d.ts
...
//#endregion
//#region src/render/text-field-substitution.d.ts
/**
...
//#endregion
//#region src/render/morph-crossfade-group.d.ts
/** A matched pair whose two halves are both painted by the overlay. */
interface MorphCrossfadeGroup {
...
//#endregion
//#region src/render/morph-plan.d.ts
/** Everything needed to play one morph transition. */
interface MorphTransitionPlan {
...
//#endregion
//#region src/render/collaboration-load-origin.d.ts
/**
 ...
 */
type CollabLoadOrigin = 'bootstrap' | 'user';
//#endregion
...
//#endregion
//#region src/render/mobile-viewport.d.ts
/**
...
//#endregion
//#region src/render/master-view.d.ts
...
//#endregion
//#region src/render/virtualized-list.d.ts
...
//#endregion
//#region src/render/toolbar-actions.d.ts
/**
...
//#endregion
//#region src/render/options/viewer-options.d.ts
/**
...
//#endregion
//#region src/export/handout-layout.d.ts
/**
...
//#endregion
//#region src/export/print-document.d.ts
/** What to print. */
...
//#endregion
//#region src/render/options/viewer-options-store.d.ts
/**
...
//#endregion
//#region src/viewer/hooks/collaboration/types.d.ts
...
type ToolbarSection = 'file' | 'home' | 'insert' | 'text' | 'arrange' | 'draw' | 'design' | 'transitions' | 'animations' | 'slideShow' | 'record' | 'review' | 'view' | 'help';
...
interface SlideCanvasProps {
  ...
  onAdjustmentPointerDown: (elementId: string, e: React$1.MouseEvent, descriptor: ShapeAdjustmentHandleDescriptor) => void;
...
//#region src/viewer/hooks/useEditorHistory.d.ts
...
//#endregion
//#region src/viewer/hooks/useZoomViewport.d.ts
...
//#endregion
//#region src/viewer/hooks/presentation-mode/useCustomShowRunner.d.ts
/**
 ...
 */
interface CustomShowDescriptor {
  id: string;
  slideRIds: string[];
}
//#endregion
//#region src/viewer/hooks/presentation-mode/types.d.ts
/**
 ...
 */
type SlideAdvanceTrigger = 'click' | 'explicit';
/**
...
interface UsePresentationModeInput {
   ...
   */
  onPlayActionSound?: (soundPath: string, options?: {
    loop?: boolean;
  }) => void;
  /**
...
//#endregion
//#region src/viewer/hooks/usePresentationMode.d.ts
declare function usePresentationMode(input: UsePresentationModeInput): UsePresentationModeResult;
//#endregion
//#region src/viewer/hooks/usePresentationAnnotations.types.d.ts
/**
...
//#endregion
//#region src/viewer/hooks/useSheetDismissDrag.d.ts
interface SheetDismissDragHandlers {
  onPointerDown: (e: React$1.PointerEvent) => void;
  onPointerMove: (e: React$1.PointerEvent) => void;
  onPointerUp: (e: React$1.PointerEvent) => void;
  onPointerCancel: (e: React$1.PointerEvent) => void;
}
...
//#endregion
//#region src/viewer/hooks/useModalDismissDrag.d.ts
...
//#endregion
//#region src/viewer/hooks/useComments-helpers.d.ts
...
interface UseCommentsResult {
   ...
   */
  handleCommentDraftChange: (slideId: string, draft: string, mentions?: PptxCommentMention[]) => void;
  ...
  handleReplyDraftChange: (commentId: string, draft: string, mentions?: PptxCommentMention[]) => void;
  handleSubmitReply: (slideIndex: number, commentId: string) => void;
}
//#endregion
//#region src/viewer/hooks/useComments.d.ts
...
//#endregion
//#region src/viewer/hooks/viewer-core-state-types.d.ts
/**
...
interface ViewerCoreState {
   ...
   */
  justInteractedRef: React$1.MutableRefObject<boolean>;
  /**
  ...
  mode: ViewerMode;
  setMode: React$1.Dispatch<React$1.SetStateAction<ViewerMode>>;
  ...
  error: string | null;
  setError: React$1.Dispatch<React$1.SetStateAction<string | null>>;
  /** The ordered array of all slides in the presentation. */
  slides: PptxSlide[];
  setSlides: React$1.Dispatch<React$1.SetStateAction<PptxSlide[]>>;
  /** Layout/master placeholder elements keyed by slide id, used for template rendering. */
  templateElementsBySlideId: Record<string, PptxElement[]>;
  setTemplateElementsBySlideId: React$1.Dispatch<React$1.SetStateAction<Record<string, PptxElement[]>>>;
  /** Width and height of the slide canvas in CSS pixels. */
  canvasSize: CanvasSize;
  setCanvasSize: React$1.Dispatch<React$1.SetStateAction<CanvasSize>>;
  /**
  ...
  setSlideSizeEmu: React$1.Dispatch<React$1.SetStateAction<SlideSizeEmu | undefined>>;
  /** Zero-based index of the currently active (visible) slide. */
  activeSlideIndex: number;
  setActiveSlideIndex: React$1.Dispatch<React$1.SetStateAction<number>>;
  /** ID of the single primarily-selected element (null when nothing is selected). */
  selectedElementId: string | null;
  setSelectedElementId: React$1.Dispatch<React$1.SetStateAction<string | null>>;
  /** IDs for multi-selection (non-empty when multiple elements are selected). */
  selectedElementIds: string[];
  setSelectedElementIds: React$1.Dispatch<React$1.SetStateAction<string[]>>;
  /** Whether unsaved changes exist in the presentation. */
  isDirty: boolean;
  setIsDirty: React$1.Dispatch<React$1.SetStateAction<boolean>>;
  /** ID of the element whose text is currently being edited inline on the canvas. */
  inlineEditingElementId: string | null;
  setInlineEditingElementId: React$1.Dispatch<React$1.SetStateAction<string | null>>;
  /** The current inline-editing text content (mirrored from the editor). */
  inlineEditingText: string;
  setInlineEditingText: React$1.Dispatch<React$1.SetStateAction<string>>;
  /** Whether the user is editing template/layout elements rather than slide elements. */
  editTemplateMode: boolean;
  setEditTemplateMode: React$1.Dispatch<React$1.SetStateAction<boolean>>;
  /** The shape type to use when the user draws the next new shape. */
  newShapeType: SupportedShapeType;
  setNewShapeType: React$1.Dispatch<React$1.SetStateAction<SupportedShapeType>>;
  /** In-memory clipboard payload for internal copy/paste of elements. */
  clipboardPayload: ElementClipboardPayload | null;
  setClipboardPayload: React$1.Dispatch<React$1.SetStateAction<ElementClipboardPayload | null>>;
  /** Monotonically-increasing nonce bumped after each pointer commit to trigger re-renders. */
  pointerCommitNonce: number;
  setPointerCommitNonce: React$1.Dispatch<React$1.SetStateAction<number>>;
  /** Header/footer configuration for the presentation. */
  headerFooter: PptxHeaderFooter;
  setHeaderFooter: React$1.Dispatch<React$1.SetStateAction<PptxHeaderFooter>>;
  /** Available slide layout options (path + display name). */
  layoutOptions: Array<{
    path: string;
    name: string;
  }>;
  setLayoutOptions: React$1.Dispatch<React$1.SetStateAction<Array<{
    path: string;
    name: string;
  }>>>;
  /** All slide masters parsed from the presentation. */
  slideMasters: PptxSlideMaster[];
  setSlideMasters: React$1.Dispatch<React$1.SetStateAction<PptxSlideMaster[]>>;
  /** Modern (`p188:person`) comment authors, for the `@`-mention typeahead. */
  modernCommentAuthors: PptxModernCommentAuthor[];
  setModernCommentAuthors: React$1.Dispatch<React$1.SetStateAction<PptxModernCommentAuthor[]>>;
  /** The deck's "Recent Colors" row (`p:clrMru`), most-recent-first. */
  recentColors: string[];
  setRecentColors: React$1.Dispatch<React$1.SetStateAction<string[]>>;
  /** The currently active theme applied to the presentation. */
  theme: PptxTheme | undefined;
  setTheme: React$1.Dispatch<React$1.SetStateAction<PptxTheme | undefined>>;
  /** Parsed table style definitions from `ppt/tableStyles.xml`. */
  tableStyleMap: ParsedTableStyleMap | undefined;
  setTableStyleMap: React$1.Dispatch<React$1.SetStateAction<ParsedTableStyleMap | undefined>>;
  /** `ppt/tableStyles.xml`'s `<a:tblStyleLst @def>` default style GUID. */
  tableStylesDefaultId: string | undefined;
  setTableStylesDefaultId: React$1.Dispatch<React$1.SetStateAction<string | undefined>>;
  /**
   ...
   */
  tableStylesToDelete: string[];
  setTableStylesToDelete: React$1.Dispatch<React$1.SetStateAction<string[]>>;
  /** Available theme presets the user can switch between. */
  themeOptions: PptxThemeOption[];
  setThemeOptions: React$1.Dispatch<React$1.SetStateAction<PptxThemeOption[]>>;
  /** Custom slide shows defined in the presentation. */
  customShows: PptxCustomShow[];
  setCustomShows: React$1.Dispatch<React$1.SetStateAction<PptxCustomShow[]>>;
  /** ID of the currently active custom show, or null for normal show. */
  activeCustomShowId: string | null;
  setActiveCustomShowId: React$1.Dispatch<React$1.SetStateAction<string | null>>;
  /** Slide sections for organizational grouping. */
  sections: PptxSection[];
  setSections: React$1.Dispatch<React$1.SetStateAction<PptxSection[]>>;
  /** Presentation-level properties (loop, show type, subtitles, etc.). */
  presentationProperties: PptxPresentationProperties;
  setPresentationProperties: React$1.Dispatch<React$1.SetStateAction<PptxPresentationProperties>>;
  /**
  ...
  setViewProperties: React$1.Dispatch<React$1.SetStateAction<PptxViewProperties | undefined>>;
  /** Notes master slide definition (background, elements, styles). */
  notesMaster: PptxNotesMaster | undefined;
  setNotesMaster: React$1.Dispatch<React$1.SetStateAction<PptxNotesMaster | undefined>>;
  /** Handout master definition for print handout layouts. */
  handoutMaster: PptxHandoutMaster | undefined;
  setHandoutMaster: React$1.Dispatch<React$1.SetStateAction<PptxHandoutMaster | undefined>>;
  /** Canvas dimensions for the notes page view (may differ from slide canvas). */
  notesCanvasSize: CanvasSize | undefined;
  setNotesCanvasSize: React$1.Dispatch<React$1.SetStateAction<CanvasSize | undefined>>;
  /** User-defined custom document properties. */
  customProperties: PptxCustomProperty[];
  setCustomProperties: React$1.Dispatch<React$1.SetStateAction<PptxCustomProperty[]>>;
  /** Tag collections associated with slides or elements. */
  tagCollections: PptxTagCollection[];
  setTagCollections: React$1.Dispatch<React$1.SetStateAction<PptxTagCollection[]>>;
  /** OPC core properties (title, author, created date, etc.). */
  coreProperties: PptxCoreProperties | undefined;
  setCoreProperties: React$1.Dispatch<React$1.SetStateAction<PptxCoreProperties | undefined>>;
  /** Application-level properties (company, version, etc.). */
  appProperties: PptxAppProperties | undefined;
  setAppProperties: React$1.Dispatch<React$1.SetStateAction<PptxAppProperties | undefined>>;
  /** Fonts embedded within the PPTX file. */
  embeddedFonts: PptxEmbeddedFont[];
  setEmbeddedFonts: React$1.Dispatch<React$1.SetStateAction<PptxEmbeddedFont[]>>;
  /** Whether the loaded presentation contains VBA macros. */
  hasMacros: boolean;
  setHasMacros: React$1.Dispatch<React$1.SetStateAction<boolean>>;
  /** Whether the loaded presentation contains digital signatures. */
  hasDigitalSignatures: boolean;
  setHasDigitalSignatures: React$1.Dispatch<React$1.SetStateAction<boolean>>;
  /** Number of digital signatures detected. */
  digitalSignatureCount: number;
  setDigitalSignatureCount: React$1.Dispatch<React$1.SetStateAction<number>>;
  /** Zero-based index of the selected slide master in master view. */
  activeMasterIndex: number;
  setActiveMasterIndex: React$1.Dispatch<React$1.SetStateAction<number>>;
  ...
  setActiveLayoutIndex: React$1.Dispatch<React$1.SetStateAction<number | null>>;
  /** The mode the viewer was in before entering master view (to restore on close). */
  preMasterMode: ViewerMode;
  setPreMasterMode: React$1.Dispatch<React$1.SetStateAction<ViewerMode>>;
  /** Active tab within the master view: slides (default), notes, or handout. */
  masterViewTab: MasterViewTab;
  setMasterViewTab: React$1.Dispatch<React$1.SetStateAction<MasterViewTab>>;
  /** Handout slides-per-page setting (1, 2, 3, 4, 6, or 9). */
  handoutSlidesPerPage: number;
  setHandoutSlidesPerPage: React$1.Dispatch<React$1.SetStateAction<number>>;
...
//#endregion
//#region src/viewer/hooks/useViewerCoreState.d.ts
/**
...
//#endregion
//#region src/viewer/hooks/useViewerUIState.d.ts
...
//#endregion
//#region src/viewer/hooks/useViewerState.d.ts
/**
...
//#endregion
//#region src/viewer/hooks/useLoadContent.d.ts
...
declare function useLoadContent({ content, clearSelection, history, setSlides, setTemplateElementsBySlideId, mediaDataUrls, setCanvasSize, setSlideSizeEmu, setHeaderFooter, setLayoutOptions, setSlideMasters, setModernCommentAuthors, setRecentColors, setTheme, setTableStyleMap, setTableStylesDefaultId, setTableStylesToDelete, setThemeOptions, setCustomShows, setActiveCustomShowId, setSections, setPresentationProperties, setViewProperties, setNotesMaster, setHandoutMaster, setNotesCanvasSize, setCustomProperties, setTagCollections, setCoreProperties, setAppProperties, setEmbeddedFonts, setActiveSlideIndex, setHasMacros, setHasDigitalSignatures, setDigitalSignatureCount, setGuides, setReadOnlyRecommendation, setModifyVerifier, setCompatToasts, setLoading, setError, setIsDirty, setIsEncrypted, onContentApplied, allowExternalImages }: UseLoadContentInput): UseLoadContentResult;
//#endregion
//#region src/viewer/hooks/useElementOperations.d.ts
/**
...
//#endregion
//#region src/viewer/hooks/useSectionOperations.d.ts
...
//#endregion
//#region src/viewer/hooks/pointer-handler-types.d.ts
...
//#endregion
//#region src/viewer/hooks/usePointerHandlers.d.ts
declare function usePointerHandlers(input: UsePointerHandlersInput): void;
//#endregion
//#region src/viewer/hooks/canvas-interaction-types.d.ts
/**
...
interface CanvasInteractionHandlers {
  ...
  handleAdjustmentPointerDown: (elementId: string, e: React.MouseEvent, descriptor: ShapeAdjustmentHandleDescriptor) => void;
...
//#endregion
//#region src/viewer/hooks/useCanvasInteractions.d.ts
...
//#endregion
//#region src/viewer/components/hyperlink-edit-types.d.ts
...
//#endregion
//#region src/viewer/hooks/useInsertElements.d.ts
...
//#endregion
//#region src/viewer/hooks/element-manipulation-types.d.ts
...
interface UseSlideManagementInput {
  ...
  handlerRef?: React$1.RefObject<PptxHandler | null> | React$1.MutableRefObject<PptxHandler | null>;
...
interface SlideManagementHandlers {
  ...
  handleSlideContextMenu: (e: React$1.MouseEvent, index: number) => void;
...
//#endregion
//#region src/viewer/hooks/table-operation-types.d.ts
...
//#endregion
//#region src/viewer/hooks/useTableOperations.d.ts
declare function useTableOperations(input: UseTableOperationsInput): TableOperationHandlers;
//#endregion
//#region src/viewer/hooks/useSerialize.d.ts
interface UseSerializeInput {
  ...
  notesMaster: PptxNotesMaster | undefined;
  handoutMaster: PptxHandoutMaster | undefined;
  handlerRef: React$1.RefObject<PptxHandler | null>;
  inlineEditingElementIdRef: React$1.MutableRefObject<string | null>;
  inlineEditingTextRef: React$1.MutableRefObject<string>;
  password?: string;
  /**
 ...
 */
type SerializeSlides = (format?: PptxSaveFormat) => Promise<Uint8Array | null>;
declare function useSerialize(input: UseSerializeInput): SerializeSlides;
//#endregion
//#region src/viewer/hooks/export-handler-types.d.ts
...
//#endregion
//#region src/viewer/hooks/useExportHandlers.d.ts
declare function useExportHandlers(input: UseExportHandlersInput): ExportHandlersResult;
//#endregion
//#region src/viewer/hooks/usePrintHandlers.d.ts
...
//#endregion
//#region src/viewer/hooks/useThemeHandlers.d.ts
...
interface ThemeHandlersResult {
  ...
  handleApplyThemeData: (colorScheme: PptxThemeColorScheme, fontScheme: PptxThemeFontScheme, themeName?: string) => Promise<void>;
...
//#endregion
//#region src/viewer/hooks/usePropertyHandlers.d.ts
...
//#endregion
//#region src/viewer/hooks/viewer-dialog-types.d.ts
/**
...
//#endregion
//#region src/viewer/hooks/useViewerDialogs.d.ts
declare function useViewerDialogs(input: UseViewerDialogsInput): ViewerDialogsResult;
//#endregion
//#region src/viewer/hooks/useDerivedSlideState.d.ts
interface UseDerivedSlideStateInput {
   ...
   */
  presentationProperties: Pick<PptxPresentationProperties, 'showSlidesMode' | 'showSlidesFrom' | 'showSlidesTo'>;
  mode: ViewerMode;
  activeLayout: PptxSlideLayout | undefined;
  activeMaster: PptxSlideMaster | undefined;
  /**
...
//#endregion
//#region src/viewer/hooks/useAnnotationHandlers.d.ts
...
//#endregion
//#region src/viewer/hooks/useRecoveryDetection.d.ts
...
interface UseRecoveryDetectionResult {
...
declare function useRecoveryDetection(input: UseRecoveryDetectionInput): UseRecoveryDetectionResult;
//#endregion
//#region src/viewer/hooks/usePresentationSetup.d.ts
...
//#endregion
//#region src/viewer/hooks/useEditorOperations.d.ts
...
//#endregion
//#region src/viewer/hooks/useIOHandlers.d.ts
interface UseIOHandlersInput {
  ...
  setContent: React$1.Dispatch<React$1.SetStateAction<ArrayBuffer | Uint8Array | null>>;
...
//#endregion
//#region src/viewer/hooks/useContentLifecycle.d.ts
interface UseContentLifecycleInput {
  ...
  history: EditorHistoryResult;
  ops: ElementOperations;
  actionSoundHandlerRef: React$1.MutableRefObject<PptxHandler | null>;
  setIsEncryptedDialogOpen: React$1.Dispatch<React$1.SetStateAction<boolean>>;
  password?: string;
  ...
  setReadOnlyRecommendation: React$1.Dispatch<React$1.SetStateAction<ReadOnlyRecommendation>>;
  /** Forwarded to {@link useLoadContent}: see `useReadOnlyRecommendationState`. */
  setModifyVerifier: React$1.Dispatch<React$1.SetStateAction<PptxModifyVerifier | undefined>>;
  /** Forwarded to {@link useLoadContent}: see `useCompatibilityToastsState`. */
  setCompatToasts: React$1.Dispatch<React$1.SetStateAction<CompatibilityWarningToast[]>>;
}
...
//#endregion
//#region src/viewer/hooks/useKeyboardShortcutWiring.d.ts
...
//#endregion
//#region src/viewer/hooks/useViewerIntegration.d.ts
...
//#endregion
//#region src/viewer/hooks/useReducedMotion.d.ts
...
//#endregion
//#region src/viewer/hooks/useViewerOptions.d.ts
interface UseViewerOptionsResult {
 ...
 */
declare function useViewerOptions(): UseViewerOptionsResult;
//#endregion
//#region src/viewer/hooks/useToolbarVisibility.d.ts
 ...
 */
declare function computeToolbarVisibility(hiddenActions: readonly ToolbarActionId[] | undefined, hiddenTabIds?: readonly ToolbarTabId[]): ToolbarVisibility;
/**
 ...
 */
declare function useToolbarVisibility(hiddenActions: readonly ToolbarActionId[] | undefined): ToolbarVisibility;
//#endregion
//#region src/viewer/hooks/useLayoutSwitching.d.ts
/**
...
//#endregion
//#region src/viewer/hooks/useVirtualizedSlides.d.ts
...
//#endregion
//#region src/viewer/hooks/useIsMobile.d.ts
...
declare function useIsMobile(): UseIsMobileResult;
//#endregion
//#region src/viewer/hooks/useTouchGestures.d.ts
...
//#endregion
//#region src/viewer/hooks/useKeyboardInsets.d.ts
...
//#endregion
//#region src/viewer/hooks/useClipboardHandlers.d.ts
...
//#endregion
//#region src/viewer/hooks/useDerivedElementState.d.ts
...
//#endregion
//#region src/viewer/hooks/useDialogCustomShows.d.ts
...
//#endregion
//#region src/viewer/hooks/useExportSaveAs.d.ts
/**
...
//#endregion
//#region src/viewer/hooks/useFontInjection.d.ts
...
//#endregion
//#region src/viewer/hooks/useGroupAlignLayerHandlers.d.ts
...
//#endregion
//#region src/viewer/hooks/useKeyboardShortcuts.d.ts
...
//#endregion
//#region src/viewer/hooks/useMergeShapesHandler.d.ts
...
//#endregion
//#region src/viewer/hooks/useResizablePanels.d.ts
...
//#endregion
//#region src/viewer/hooks/useSwipeNavigation.d.ts
...
interface UseSwipeNavigationResult {
  onTouchStart: (e: React$1.TouchEvent) => void;
  onTouchEnd: (e: React$1.TouchEvent) => void;
}
declare function useSwipeNavigation(input: UseSwipeNavigationInput): UseSwipeNavigationResult;
//#endregion
//#region src/viewer/hooks/presentation-mode/useAnimationPlayback.d.ts
...
interface SeedSlideAnimationOptions {
  /**
...
interface UseAnimationPlaybackResult {
  ...
  handleHoverStart: (shapeId: string) => boolean;
  handleHoverEnd: (shapeId: string) => void;
  runPresentationEntranceAnimations: (slideIndex: number, options?: SeedSlideAnimationOptions) => void;
  /**
...
//#endregion
//#region src/viewer/hooks/presentation-mode/useRehearsalTimings.d.ts
...
//#endregion
//#region src/viewer/hooks/presentation-mode/usePresentationKeyboard.d.ts
...
//#endregion
//#region src/viewer/hooks/presentation-mode/useSlideNavigation.d.ts
interface UseSlideNavigationInput {
  ...
  seedSlideAnimations: (slideIndex: number, options?: {
    completed?: boolean;
  }) => void;
...
//#endregion
//#region src/viewer/hooks/presentation-mode/useZoomNavigation.d.ts
/**
...
//#endregion
//#region src/viewer/hooks/presentation-mode/useAudienceMode.d.ts
...
export { MIN_TOUCH_TARGET, MOBILE_BREAKPOINT, TABLET_BREAKPOINT, computeToolbarVisibility, computeVirtualRange, useAnimationPlayback, useAnnotationHandlers, useAudienceMode, useAutosave, useBroadcastFollower, useCanvasInteractions, useClipboardHandlers, useCollaborativeHistory, useCollaborativeState, useComments, useContentLifecycle, useDerivedElementState, useDerivedSlideState, useDialogCustomShows, useEditorHistory, useEditorOperations, useElementManipulation, useElementOperations, useExportHandlers, useExportSaveAs, useFindReplace, useFollowMode, useFontInjection, useGroupAlignLayerHandlers, useIOHandlers, useInsertElements, useIsMobile, useKeyboardInsets, useKeyboardShortcutWiring, useKeyboardShortcuts, useLayoutSwitching, useLoadContent, useMergeShapesHandler, useModalDismissDrag, usePointerHandlers, usePresenceTracking, usePresentationAnnotations, usePresentationKeyboard, usePresentationMode, usePresentationSetup, usePresenterWindow, usePrintHandlers, usePropertyHandlers, useRecoveryDetection, useReducedMotion, useRehearsalTimings, useResizablePanels, useSectionOperations, useSerialize, useSheetDismissDrag, useSlideManagement, useSlideNavigation, useSwipeNavigation, useTableOperations, useThemeHandlers, useThemeSwitching, useToolbarVisibility, useTouchGestures, useViewerBuildingBlocks, useViewerCoreState, useViewerDialogs, useViewerIntegration, useViewerOptions, useViewerState, useViewerUIState, useVirtualizedSlides, useYjsDocumentSync, useYjsProvider, useZoomNavigation, useZoomViewport };
export type { AnnotationHandlersResult, AnnotationStroke, AutosaveStatus, CanvasInteractionHandlers, CollaborationConfig, CollaborationContextValue, ConnectionStatus, ContentLifecycleResult, DerivedElementState, DerivedSlideState, DeviceOrientation, EditorHistoryInput, EditorHistoryResult, EditorOperationsResult, ElementManipulationHandlers, ElementOperations, ExportHandlersResult, ExportSaveAsResult, IOHandlersResult, InsertElementHandlers, LayoutSwitchingResult, MergeShapesHandlerInput, MergeShapesHandlers, ModalDismissDrag, ModalDismissDragHandlers, PresentationSetupResult, PresentationTool, PrintHandlersResult, PropertyHandlersResult, SectionOperations, SheetDismissDrag, SheetDismissDragHandlers, SlideManagementHandlers, TableOperationHandlers, ThemeHandlersResult, ThemeSwitchingResult, ToolbarVisibility, TouchGestureCallbacks, UseAnimationPlaybackInput, UseAnimationPlaybackResult, UseAnnotationHandlersInput, UseAutosaveInput, UseAutosaveResult, UseBroadcastFollowerInput, UseCanvasInteractionsInput, UseCollaborativeHistoryInput, UseCollaborativeHistoryResult, UseCollaborativeStateInput, UseContentLifecycleInput, UseDerivedElementStateInput, UseDerivedSlideStateInput, UseDialogCustomShowsInput, UseDialogCustomShowsResult, UseEditorOperationsInput, UseElementManipulationInput, UseElementOperationsInput, UseExportHandlersInput, UseExportSaveAsInput, UseFollowModeInput, UseFollowModeResult, UseFontInjectionInput, UseIOHandlersInput, UseInsertElementsInput, UseIsMobileResult, UseKeyboardInsetsResult, UseKeyboardShortcutWiringInput, UseKeyboardShortcutsInput, UseLayoutSwitchingInput, UseLoadContentInput, UseLoadContentResult, UsePointerHandlersInput, UsePresenceTrackingInput, UsePresenceTrackingResult, UsePresentationAnnotationsResult, UsePresentationSetupInput, UsePresenterWindowInput, UsePresenterWindowResult, UsePrintHandlersInput, UsePropertyHandlersInput, UseRecoveryDetectionInput, UseReducedMotionResult, UseRehearsalTimingsInput, UseRehearsalTimingsResult, UseResizablePanelsResult, UseSectionOperationsInput, UseSerializeInput, UseSlideManagementInput, UseSlideNavigationInput, UseSlideNavigationResult, UseSwipeNavigationInput, UseSwipeNavigationResult, UseTableOperationsInput, UseThemeHandlersInput, UseThemeSwitchingInput, UseTouchGesturesInput, UseViewerBuildingBlocksInput, UseViewerCoreStateInput, UseViewerDialogsInput, UseViewerIntegrationInput, UseViewerOptionsResult, UseViewerStateInput, UseYjsDocumentSyncInput, UseYjsProviderInput, UseYjsProviderResult, UseZoomNavigationInput, UseZoomNavigationResult, UserPresence, ViewerBuildingBlocksResult, ViewerCoreState, ViewerDialogsResult, ViewerIntegrationResult, ViewerState, ViewerUIState, VirtualizedRange, VirtualizedSlidesOptions, VirtualizedSlidesResult };

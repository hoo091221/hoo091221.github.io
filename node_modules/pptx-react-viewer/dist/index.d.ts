...
//#endregion
//#region src/theme/theme-catalog.d.ts
 ...
 */
interface SlideTemplateBuildOptions {
...
interface SlideTemplateBuildResult {
...
//#endregion
//#region src/render/slide-templates/slide-template-catalog.d.ts
/** Ordered gallery catalogue: one entry per built-in slide template. */
declare const SLIDE_TEMPLATES: readonly SlideTemplateSpec[];
/**
 ...
 */
declare function buildSlideTemplateContent(id: SlideTemplateId, options?: SlideTemplateBuildOptions): SlideTemplateBuildResult;
/**
 ...
 */
declare function buildSlideTemplateSlide(templateId: SlideTemplateId, slideId: string, slideNumber: number, options?: SlideTemplateBuildOptions): PptxSlide;
...
//#endregion
//#region src/render/account.d.ts
...
type StoredViewerOptions = { [G in ViewerOptionsGroupId]?: Partial<ViewerOptions[G]>; };
//#endregion
//#region src/render/viewer-prefs-storage.d.ts
/**
...
declare function SlideTemplateGalleryDialog({ isOpen, onClose, onInsert, scheme }: SlideTemplateGalleryDialogProps): React$1__default.ReactElement | null;
//#endregion
//#region src/viewer/components/SlideTemplatePreview.d.ts
interface SlideTemplatePreviewProps {
  templateId: SlideTemplateId;
  /** Optional deck scheme so the preview shows the deck's theme colours. */
  scheme?: Record<string, string>;
}
declare function SlideTemplatePreview({ templateId, scheme }: SlideTemplatePreviewProps): React$1__default.ReactElement;
//#endregion

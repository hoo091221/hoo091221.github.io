...
var PerformanceMonitor = class {
  ...
  */
  start(name, metadata) {
    ...
    if (this.activeMetrics.has(name)) (_a7 = this.context) == null ? void 0 : _a7.logger.warn(`Performance metric '${name}' already started. Overwriting.`);
  ...
  */
    ...
    if (!metric) {
      (_a7 = this.context) == null ? void 0 : _a7.logger.warn(`Performance metric '${name}' not found. Was start() called?`);
      return;
    }
...
var DocumentCloner = class {
  ...
  toIFrame(ownerDocument, windowSize) {
    ...
    try {
      const ownerWindow = (_a7 = this.referenceElement.ownerDocument) == null ? void 0 : _a7.defaultView;
  ...
  createCanvasClone(canvas) {
    ...
    try {
      ...
      if (clonedCtx) if (!this.options.allowTaint && ctx) clonedCtx.putImageData(ctx.getImageData(0, 0, canvas.width, canvas.height), 0, 0);
        ...
        if (gl) {
          if (((_a7 = gl.getContextAttributes()) == null ? void 0 : _a7.preserveDrawingBuffer) === false) this.context.logger.warn("Unable to clone WebGL context as it has preserveDrawingBuffer=false", canvas);
        }
...
var getTextStrokeLineJoin = () => {
  var _a7;
  return ((_a7 = typeof window !== "undefined" ? window : void 0) == null ? void 0 : _a7.chrome) ? "miter" : "round";
};
var TextRenderer = class {
  ...
  iterateVerticalGlyphs(text, letterSpacing2, baseline, writingMode2, renderFn) {
    ...
    for (let i = 0; i < letters.length; ) {
      ...
      while (i < letters.length) {
        ...
        if (isSidewaysWritingMode(writingMode2) || !hasCJKCharacters(ch) && ch.trim().length > 0) i++;
        else break;
      }
      this.ctx.save();
  ...
  */
  renderLineClampedText(text, styles, paintOrder2, baseline, containerBounds) {
    ...
    for (let i = 0; i < maxLines - 1; i++) lines[i].forEach((tb) => this.renderTextBoundWithPaintOrder(tb, styles, paintOrder2, baseline));
  ...
  */
  async renderBackgroundURLImage(container, backgroundImage2, index) {
    ...
    try {
      ...
      (_b2 = (_a7 = this.context).onError) == null ? void 0 : _b2.call(_a7, e instanceof Error ? e : new Error(String(e)));
    }
    if (image2) {
  ...
  */
  renderRadialGradient(container, backgroundImage2, index) {
    ...
    if (rx > 0 && ry > 0) {
      ...
      const stops = processColorStops(backgroundImage2.stops, rx * 2);
...
async function renderReplacedElements(ctx, context, options, iframeRendererFactory, container, curves, styles, renderReplacedElementFn) {
  ...
  if (container instanceof ImageElementContainer) try {
    ...
    (_a7 = context.onError) == null ? void 0 : _a7.call(context, e instanceof Error ? e : new Error(String(e)));
  }
  ...
  if (container instanceof SVGElementContainer) try {
    ...
    (_b2 = context.onError) == null ? void 0 : _b2.call(context, e instanceof Error ? e : new Error(String(e)));
  }
...
var ForeignObjectRenderer = class {
  ...
  async render(element) {
    var _a7;
    if ((_a7 = this.options.signal) == null ? void 0 : _a7.aborted) throw new DOMException("The operation was aborted.", "AbortError");
...
html2canvas-pro/dist/html2canvas-pro.esm.js:
  ...
  *)
*/
//# sourceMappingURL=html2canvas-pro.esm-7UJ6T6UA.js.map
